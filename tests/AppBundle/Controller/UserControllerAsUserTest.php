...
class UserControllerAsUserTest extends WebTestCase
{
    ...
    public function testUserList()
    {
        ...
        static::assertSame(1, $crawler->filter('html:contains("Edit")')->count());
    }
    ...
    public function testUserCreate()
    {
        ...
        $form['user[email]'] = 'userUser@mail.fr';
    ...
    public function testUserCreateUsernameNotUnique()
    {
        ...
        $form['user[password][first]'] = 'password';
        $form['user[password][second]'] = 'password';
        $form['user[email]'] = 'userUser2@mail.fr';
...
//    }
//
//    public function testUserEditPasswordNOK()
//    {
//        $crawler = $this->client->request('GET', '/users');
//
//        $link = $crawler->selectLink('Edit')->link();
...
//
//        $form = $crawler->selectButton('Modifier')->form();
//        $form['user_edit[email]'] = 'email@mail.fr';
//        $crawler=$this->client->submit($form);
//
//        static::assertEquals(200, $this->client->getResponse()->getStatusCode());
//        static::assertSame(1, $crawler->filter('html:contains("Cet email est déjà utilisé.") ')->count());
